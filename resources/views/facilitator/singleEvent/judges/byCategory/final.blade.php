<div class="card w-100 mx-2 mb-3">
    <div class="card-body px-3 pt-3">
        <h3 class="card-title">Cronation night
                        ...
                        <tr id="judgeRow{{ $judge->id }}">
                            ...
                            <td class="d-flex">
                                ...
                                <div>
                                    ...
                                    <button class="btn btn-outline-secondary btn btn-sm eventJudges"
                                        id="copyBtn-{{ $judge->accessCode }}" code={{ $judge->accessCode }}
                                        category="Final" eventId={{ $event->id }}><i class="fa fa-clipboard"></i>
                                    </button>
